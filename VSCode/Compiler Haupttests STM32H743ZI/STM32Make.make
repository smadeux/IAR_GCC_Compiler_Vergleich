...
# target
######################################
TARGET = Compiler_Haupttests_STM32H743ZI
...
GCC_PATH="C:/DEV/TOOLS/GCC-ARM-NONE-EABI-10.3-2021.07/BIN
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"C:/DEV/TOOLS/OPENOCD-20210729-0.11.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"C:/DEV/TOOLS/OPENOCD-20210729-0.11.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32h7x mass_erase 0; exit"
